            ...
            Ok(hash) => {
                ...
                if hash_to_expected_name.contains_key(&hash) {
                    ...
                    if expected_name == &actual_name {
                        ...
                        println!("✓ {actual_name} matches hash for '{expected_name}' (needs rename)");
                    }
                }
            }
...
mod tests {
    ...
    #[test]
    fn test_find_file() {
        let target_hash = vec![174, 93, 175, 166, 105, 86, 69, 252, 44, 193, 189, 17, 136, 199, 90, 69];
        let directory = Path::new("/tmp/nzb/downloads/downloads/inter/almost_downloaded/");
